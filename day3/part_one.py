...
if __name__ == "__main__":
    ...
    for d in data:
        ...
        for i in range(len(buf0)):
            ...
            if c1 != "." and not c1.isnumeric():    # if its a symbol
                part_numbers.extend(checkMid(i, buf0))  # check first line
                part_numbers.extend(checkMid(i, buf1))  # check current line
                part_numbers.extend(checkMid(i, buf2))  # check third line
